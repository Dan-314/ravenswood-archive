...
async function main() {
  ...
  for (const lang of qualifying) {
    ...
    // Fetch team labels and UI labels from app-interface component
    const { teams: teamLabels, ui: uiLabels } = await fetchAppInterfaceLabels(code);
    Object.assign(translationData.teams, teamLabels);
    Object.assign(translationData.ui, uiLabels);
